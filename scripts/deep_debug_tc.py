...
from src.tc_grader import compute_adaptive_params
from src.tc_gemini import _load_api_key, SYSTEM_PROMPT, _build_user_prompt, _strip_signal_echo, _is_buffer_echo
from src.tc_constants import GEMINI_MODEL, GEMINI_TIMEOUT
from src.tc_context import load_context
from src.tc_context_agent import select_context_ensemble
from src.tc_trajectory import build_trajectory
...
# 7. Simulate the extraction logic from tc_gemini
print(f'\n[7] EXTRACTION LOGIC (mirrors tc_gemini)')
text = ''
if candidates:
