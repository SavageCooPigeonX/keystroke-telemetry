...
def test_compiled_codex_compat_has_real_sibling_imports_not_runtime_bridge():
    generated = list(PACKAGE.glob("codex_compat_seq*_v*.py"))
...
def test_compiled_codex_compat_writes_compile_lineage_aliases():
    ...
    assert build_alias["current_file"] == "codex_compat/codex_compat_seq022_v001.py"
...
def test_file_sim_resolves_split_identity_aliases():
    ...
    assert targets[0] == "codex_compat/codex_compat_seq022_v001.py"
...
def test_file_sim_context_selection_uses_split_identity_aliases():
    ...
    assert result["proposals"][0]["path"] == "codex_compat/codex_compat_seq022_v001.py"
