...
| 002 | stress_test.py | 335 | 🟠 WARN | SCENARIOS, classify_state(), STATE_COLORS, RESET, DIVIDER +6 |  | operator state recognition via typing telemetry. |  |
| 003 | test_all.py | 330 | 🟠 WARN | sim_type(), sim_backspace(), test_logger(), test_context_budget(), test_drift_watcher() +3 |  | exercises logger, context budget, drift watcher, resistance bridge. |  |
