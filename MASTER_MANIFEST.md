...
| Component | Role |
|---|---|
| `PigeonBrain.jsx` | Main graph — ReactFlow with 125 profiler-card nodes, live edge animation (green glow + drop-shadow), LIVE/OFFLINE indicator |
...
| `pigeon_brain/dual_view.json` | 125 enriched neurons — dual-substrate heat per node | `py -m pigeon_brain dual` |
| `pigeon_brain/graph_cache.json` | Graph topology cache (125 nodes, 72 edges) | `py -m pigeon_brain graph` |
