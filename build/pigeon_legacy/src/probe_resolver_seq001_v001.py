"""probe_resolver_seq001_v001 — auto-answer copilot uncertainty probes from live telemetry.
...
from .probe_surface_seq001_v001 import write_resolution, _probe_fingerprint
...
def resolve_all_pending(root: Path, auto_write: bool = True) -> dict:
    ...
    """
    from .probe_surface_seq001_v001 import harvest_pending_probes
