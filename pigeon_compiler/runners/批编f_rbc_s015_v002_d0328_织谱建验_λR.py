"""Pigeon compliance facade for pigeon_compiler/runners/批编f_rbc_s015_v002_d0328_织谱建验_λR.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_compiler/runners/批编f_rbc_s015_v002_d0328_织谱建验_λR.py')
