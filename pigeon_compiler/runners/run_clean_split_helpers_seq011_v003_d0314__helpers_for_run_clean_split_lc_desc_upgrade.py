...
# ── pigeon ────────────────────────────────────
# SEQ: 011 | VER: v003 | 51 lines | ~503 tokens
...
def decompose_oversized(source_file: Path, em: dict) -> tuple:
    ...
    from pigeon_compiler.cut_executor.source_slicer_seq002_v003_d0314__extract_functions_constants_from_source_lc_desc_upgrade import (
