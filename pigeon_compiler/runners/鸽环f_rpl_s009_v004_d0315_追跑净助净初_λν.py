...
from pigeon_compiler.state_extractor.拆f_emb_s006_v004_d0315_追跑改名谱建_λν import save_ether_map
from pigeon_compiler.weakness_planner.核w_dspp_s004_v003_d0314_测编深划鸽环_λD import request_cut_plan
...
from pigeon_compiler.cut_executor.译f_fdc_s008_v005_d0322_净拆测编深划_λ7 import (
    find_oversized, decompose_function)
from pigeon_compiler.cut_executor.切p_ss_s002_v004_d0315_重箱重助重拆_λν import _node_name, _node_range
    ...
    for func_info in sorted(big, key=lambda f: -f["start_line"]):
        ...
        for node in ast.iter_child_nodes(tree):
            if _node_name(node) == name:
                ...
                try:
                    from pigeon_compiler.integrations.谱p_dsa_s001_v006_d0322_读_λ7 import deepseek_query
