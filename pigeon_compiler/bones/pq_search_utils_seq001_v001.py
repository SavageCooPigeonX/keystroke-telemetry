...
def compute_session_stats(session: dict) -> dict:
    ...
    from maif_whisperer.persona.hush_prompt_seq001_v001 import MODEL_CONTEXT_TOKENS
...
def fallback_direct_write(guidance: dict, session: dict, session_id: str, result: dict) -> dict:
    ...
    if write_shards and write_hints:
        try:
            from maif_whisperer.memory.distributed_memory_seq002_v001 import direct_shard_append_batch
