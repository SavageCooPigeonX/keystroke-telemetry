"""Pigeon compliance facade for pigeon_compiler/weakness_planner/核w_dspp_s004_v003_d0314_测编深划鸽环_λD.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_compiler/weakness_planner/核w_dspp_s004_v003_d0314_测编深划鸽环_λD.py')
