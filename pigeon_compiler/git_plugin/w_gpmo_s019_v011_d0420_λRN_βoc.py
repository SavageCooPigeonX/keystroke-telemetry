"""Pigeon compliance facade for pigeon_compiler/git_plugin/w_gpmo_s019_v011_d0420_λRN_βoc.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_compiler/git_plugin/w_gpmo_s019_v011_d0420_λRN_βoc.py')
