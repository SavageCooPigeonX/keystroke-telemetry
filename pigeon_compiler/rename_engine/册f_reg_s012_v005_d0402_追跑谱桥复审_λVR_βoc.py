"""Pigeon compliance facade for pigeon_compiler/rename_engine/册f_reg_s012_v005_d0402_追跑谱桥复审_λVR_βoc.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_compiler/rename_engine/册f_reg_s012_v005_d0402_追跑谱桥复审_λVR_βoc.py')
