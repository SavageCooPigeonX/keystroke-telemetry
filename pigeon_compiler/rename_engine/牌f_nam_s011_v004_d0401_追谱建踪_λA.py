"""Pigeon compliance facade for pigeon_compiler/rename_engine/牌f_nam_s011_v004_d0401_追谱建踪_λA.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_compiler/rename_engine/牌f_nam_s011_v004_d0401_追谱建踪_λA.py')
