"""追跑f_ruhe_s010_v005_d0403_册复审净助_λFX_βoc_orchestrator_seq012_v001.py — Auto-extracted by Pigeon Compiler."""
...
def run_heal_pipeline(root: str, execute: bool = False,
    ...
    if not manifests_only and not skip_rename:
        _run_heal_pipeline_rename_stage(root, report, execute, intent)
