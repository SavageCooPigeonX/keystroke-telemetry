"""追跑f_ruhe_s010_v005_d0403_册复审净助_λFX_βoc_rename_stage_seq006_v001.py — Auto-extracted by Pigeon Compiler."""
...
def _run_heal_pipeline_rename_stage(root: Path, report: dict, execute: bool, intent: str):
