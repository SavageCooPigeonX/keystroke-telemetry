"""追跑f_ruhe_s010_v005_d0403_册复审净助_λFX_βoc_stage_rename_seq007_v001.py — Auto-extracted by Pigeon Compiler."""
...
def _run_heal_pipeline_rename_stage(root: Path, report: dict, execute: bool,
                                    intent: str, registry):
