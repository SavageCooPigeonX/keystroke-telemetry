"""追跑f_ruhe_s010_v005_d0403_册复审净助_λFX_βoc_manifest_stage_seq005_v001.py — Auto-extracted by Pigeon Compiler."""
from pathlib import Path
from pigeon_compiler.rename_engine.谱建f_mb_s007_v003_d0314_观重箱重拆_λD import build_all_manifests

def _run_heal_pipeline_rebuild_manifests(root: Path, execute: bool,
                                         manifests_only: bool) -> dict:
