"""
uia_reader.py — Windows UI Automation reader for live chat input capture.
...
Usage: py client/uia_reader.py <project_root>
       py client/uia_reader.py <project_root> --diag   (diagnostic: log everything)
"""
import json
import os
import sys
