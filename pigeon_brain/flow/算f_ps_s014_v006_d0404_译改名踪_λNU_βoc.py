"""Pigeon compliance facade for pigeon_brain/flow/算f_ps_s014_v006_d0404_译改名踪_λNU_βoc.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_brain/flow/算f_ps_s014_v006_d0404_译改名踪_λNU_βoc.py')
