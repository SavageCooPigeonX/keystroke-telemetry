"""Pigeon compliance facade for pigeon_brain/flow/虫f_bdm_s015_v001_d0410_λFT.py."""
...
load_legacy_module(__name__, globals(), 'pigeon_brain/flow/虫f_bdm_s015_v001_d0410_λFT.py')
