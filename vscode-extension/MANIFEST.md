...
|-----|------|------:|--------|---------|------|-------------|-------|
| 001 | classify_bridge.py | 321 | 🟠 WARN |  |  | Classify bridge |  |
| 002 | pulse_watcher.py | 49 | ✅ | main() | pulse_harvest | Save-time pulse correlator. |  |

## Health
- **Files:** 2 | **Compliant:** 1/2 (50%)
- **Total lines:** 370 | **Est. tokens:** ~0 | **Target:** ≤200 per file
