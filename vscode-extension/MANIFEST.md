...
|-----|------|------:|--------|---------|------|-------------|-------|
| 001 | classify_bridge.py | 271 | ⚠️ OVER | LLM_REWRITE_EVERY, main() | git_plugin | VS Code extension ↔ Python classifier bridge. |  |

## Health
- **Files:** 1 | **Compliant:** 0/1 (0%)
- **Total lines:** 271 | **Est. tokens:** ~0 | **Target:** ≤200 per file
...
|--------|----------|-------|
| classify_bridge | `LLM_REWRITE_EVERY` | `8` |
