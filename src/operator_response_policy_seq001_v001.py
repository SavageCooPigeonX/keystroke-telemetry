"""Pigeon compliance facade for src/operator_response_policy_seq001_v001.py."""
...
load_legacy_module(__name__, globals(), 'src/operator_response_policy_seq001_v001.py')
