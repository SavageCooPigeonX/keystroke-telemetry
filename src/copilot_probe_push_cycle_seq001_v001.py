"""Pigeon compliance facade for src/copilot_probe_push_cycle_seq001_v001.py."""
...
load_legacy_module(__name__, globals(), 'src/copilot_probe_push_cycle_seq001_v001.py')
