"""rework_scorecard — single source of truth for AI rework rate.
...
Writes logs/rework_scorecard.json. All managed prompt blocks MUST read from
this file rather than computing their own slice.

Usage:
    from src.rework_scorecard import update_scorecard, load_scorecard
...
SCORECARD = Path("logs/rework_scorecard.json")
