"""Pigeon compliance facade for src/autonomous_mutation_audit_seq001_v001.py."""
...
load_legacy_module(__name__, globals(), 'src/autonomous_mutation_audit_seq001_v001.py')
