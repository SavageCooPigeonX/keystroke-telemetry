...
def ask_tc(question: str, context: str = '', entropy: float = 0.0,
    ...
    try:
        from .tc_manifest import match_intent_profile, parse_questions, add_question
...
def answer_question(question_id: str, answer: str,
    ...
    """
    try:
        from .tc_manifest import answer_question as manifest_answer
...
def get_pending_questions() -> list[dict]:
    ...
    try:
        from .tc_manifest import parse_questions
