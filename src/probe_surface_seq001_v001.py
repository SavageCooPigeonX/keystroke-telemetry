"""probe_surface_seq001_v001 — structured uncertainty probes emitted by copilot during edits.
...
mirrors entropy:shed but bidirectional:
  ...
  resolve: probe_resolver_seq001_v001 auto-answers from telemetry or surfaces to operator
...
probe lifecycle:
  ...
  3. chat_response_reader_seq001_v001 captures response → logs/ai_responses.jsonl
  4. probe_surface_seq001_v001.parse_probe_blocks() extracts pending probes
  5. probe_resolver_seq001_v001 resolves from: unsaid_recon, prompt_journal, composition signal
