...
Data sources merged per file:
  - push_baseline: genesis snapshot, drift, voids, context growth
  ...
  - numeric_surface: graph edges (who imports, who gets imported)
...
Launch: called by push_cycle step 14 or manually:
  py -m src.file_semantic_layer
  py -c "from src.file_semantic_layer import inspect_module; ..."
"""
...
SEMANTIC_DB = 'logs/file_semantic_layer.json'
...
NUMERIC_SURFACE = 'logs/numeric_surface.json'
