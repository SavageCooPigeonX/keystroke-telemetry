...
Usage:
    py src/tc_intel_report.py                  # print to stdout
    py src/tc_intel_report.py -o intel.md      # write to file
    py src/tc_intel_report.py --section voice  # single shard
    py src/tc_intel_report.py --secrets        # just the intelligence file
"""
