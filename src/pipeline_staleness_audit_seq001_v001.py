"""Pigeon compliance facade for src/pipeline_staleness_audit_seq001_v001.py."""
...
load_legacy_module(__name__, globals(), 'src/pipeline_staleness_audit_seq001_v001.py')
