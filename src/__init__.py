...
# --- stable core ---
_safe("from .bug_profiles_seq001_v001 import generate_profiles")
_safe("from .codebase_transmuter_seq001_v001 import numerify_file, build_numerical_mirror, build_narrative_mirror, compute_global_stats, transmute_all")
_safe("from .context_compressor_seq001_v001 import compress_file, compress_changed")
_safe("from .engagement_hooks_seq001_v001 import generate_hooks, build_hooks_block, inject_hooks")
_safe("from .entropy_shedding_seq001_v001 import parse_shed_blocks, parse_shed_block, accumulate_entropy, build_entropy_block, build_red_layer_block, format_shed_block")
_safe("from .intent_compressor_seq001_v001 import strip_metadata, strip_syntactic_noise, collapse_imports, skeleton, intent_map, CompressionResult, compress_file, compress_all")
_safe("from .numeric_surface_seq001_v001 import generate_surface")
...
_safe("from .self_fix_tracker_seq001_v001 import compute_accuracy, build_narrative_block")
_safe("from .template_selector_seq001_v001 import detect_mode, hydrate_templates, inject_active_template")
...
_safe("from .interlinker_seq001_v001 import assess_module, interlink_module, interlink_scan, generate_self_test, write_self_test, run_self_test, accumulate_shard, build_interlink_report, load_interlink_db")
_safe("from .interlinker_seq001_v001_upgrade_seq001_v001 import upgrade_test, run_upgrade_cycle, pick_upgrade_candidates")
