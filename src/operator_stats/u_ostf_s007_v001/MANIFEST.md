# MANIFEST — src/operator_stats/u_ostf_s007_v001

> u_ostf_s007_v001/ — Pigeon-compliant module.
...
|-----|------|------:|--------|---------|------|-------------|-------|
| 001 | u_ostf_s007_v001_render_timeframes_seq001_v001.py | 55 | ✅ |  |  | Auto-extracted by Pigeon Compiler. |  |

## Health
- **Files:** 1 | **Compliant:** 1/1 (100%)
- **Total lines:** 55 | **Est. tokens:** ~404 | **Target:** ≤200 per file

## Pigeon Metadata

| File | Ver | Tokens | Sessions | Last Modified | Intent |
|------|-----|-------:|---------:|---------------|--------|
| u_ostf_s007_v001_render_timeframes | v001 | 404 | 0 | 2026-04-14 @ heal | (none) |
