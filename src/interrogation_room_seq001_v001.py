...
Launch:  py src/interrogation_room_seq001_v001.py
         py src/interrogation_room_seq001_v001.py --port 8236 --top 10
         py src/interrogation_room_seq001_v001.py --list  (print queue, no server)
...
Reinjection loop:
  prompt_journal → interrogation answers → tc_context_seq001_v001.py →
