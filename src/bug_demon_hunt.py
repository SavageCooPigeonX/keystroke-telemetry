"""bug_demon_hunt.py — bug demons write their own manifests, flow through veins, files propose fixes.
...
Usage:
    py src/bug_demon_hunt.py                          # full hunt: overcap maw
    py src/bug_demon_hunt.py --bug hardcoded_import   # hunt specific demon
    py src/bug_demon_hunt.py --proposals              # skip hunt, go to proposals
    py src/bug_demon_hunt.py --stress-test            # hunt bugs in the hunt system itself
"""
...
def _load_bug_profiles() -> dict[str, list[dict]]:
