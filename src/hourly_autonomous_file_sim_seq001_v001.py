"""Pigeon compliance facade for src/hourly_autonomous_file_sim_seq001_v001.py."""
...
load_legacy_module(__name__, globals(), 'src/hourly_autonomous_file_sim_seq001_v001.py')
