...
"""
# ── pigeon ────────────────────────────────────
# SEQ: 022 | VER: v001 | ~130 lines
# DESC:   rework_backfill_from_chat_history
# INTENT: backfill_rework
# ──────────────────────────────────────────────
# ── telemetry:pulse ──
# EDIT_TS:   None
# EDIT_HASH: None
...
def backfill(root: Path) -> int:
    ...
    score_rework = _load_src('rework_detector_seq009*.py', 'score_rework')
    record_rework = _load_src('rework_detector_seq009*.py', 'record_rework')
