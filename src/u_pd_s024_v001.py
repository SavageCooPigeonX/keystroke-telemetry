...
Usage:
    py -m src.u_pd_s024_v001 [block_name] [N]
...
Examples:
    py -m src.u_pd_s024_v001                       # list all sections
    py -m src.u_pd_s024_v001 "Module Map"          # diff last 2 snapshots of Module Map
    py -m src.u_pd_s024_v001 features 5            # show feature evolution over last 5 snapshots
