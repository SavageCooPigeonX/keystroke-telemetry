"""Interlink self-test for operator_probes.

Auto-generated. This test keeps operator_probes interlinked.
...
def test_import():
    ...
    from src.operator_probes import build_probe_block, inject_probes
    ...
    print(f"  ✓ operator_probes: 2 exports verified")

def test_build_probe_block_contract():
    """Data flow contract: build_probe_block(root) → output."""
    from src.operator_probes import build_probe_block
...
def run_interlink_test():
    """Run all interlink checks for operator_probes."""
    ...
    print(f"  operator_probes: {status}")
    return passed == total
