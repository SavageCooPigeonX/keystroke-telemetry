"""Interlink self-test for tc_context_seq001_v001_agent_seq001_v001.

Auto-generated. This test keeps tc_context_seq001_v001_agent_seq001_v001 interlinked.
...
def test_import():
    ...
    from src.tc_context_seq001_v001_seq001_v001_agent_seq001_v001_seq001_v001 import select_context_files, build_code_context
    ...
    print(f"  ✓ tc_context_seq001_v001_agent_seq001_v001: 2 exports verified")
...
def test_build_code_context_contract():
    ...
    from src.tc_context_seq001_v001_seq001_v001_agent_seq001_v001_seq001_v001 import build_code_context
    # smoke test: function exists and is callable
    assert build_code_context.__name__ == "build_code_context"
    print(f"  ✓ build_code_context: contract holds")

def run_interlink_test():
    """Run all interlink checks for tc_context_seq001_v001_agent_seq001_v001."""
    ...
    print(f"  tc_context_seq001_v001_agent_seq001_v001: {status}")
    return passed == total
