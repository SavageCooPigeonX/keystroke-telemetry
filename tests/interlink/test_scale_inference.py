...
def test_import():
    ...
    from src.scale_inference_seq001_v001 import infer_scale, scale_to_token_budget, scale_to_instructions
...
def test_scale_to_instructions_contract():
    ...
    from src.scale_inference_seq001_v001 import scale_to_instructions
    # smoke test: function exists and is callable
