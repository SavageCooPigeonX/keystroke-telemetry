"""Interlink self-test for scale_inference.

Auto-generated. This test keeps scale_inference interlinked.
...
def test_import():
    ...
    from src.scale_inference import infer_scale, scale_to_token_budget, scale_to_instructions
    ...
    print(f"  ✓ scale_inference: 3 exports verified")
...
def run_interlink_test():
    """Run all interlink checks for scale_inference."""
    ...
    print(f"  scale_inference: {status}")
    return passed == total
