"""Interlink self-test for narrative_glove.

Auto-generated. This test keeps narrative_glove interlinked.
...
def run_interlink_test():
    """Run all interlink checks for narrative_glove."""
    ...
    print(f"  narrative_glove: {status}")
    return passed == total
