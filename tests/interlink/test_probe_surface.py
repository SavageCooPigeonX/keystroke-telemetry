"""Interlink self-test for probe_surface.

Auto-generated. This test keeps probe_surface interlinked.
...
def test_import():
    ...
    from src.probe_surface import parse_probe_blocks, harvest_pending_probes, write_resolution, build_resolution_block
    ...
    print(f"  ✓ probe_surface: 4 exports verified")

def test_parse_probe_blocks_contract():
    """Data flow contract: parse_probe_blocks(text) → output."""
    from src.probe_surface import parse_probe_blocks
...
def test_harvest_pending_probes_contract():
    ...
    from src.probe_surface import harvest_pending_probes
    # smoke test: function exists and is callable
...
def test_write_resolution_contract():
    ...
    from src.probe_surface import write_resolution
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for probe_surface."""
