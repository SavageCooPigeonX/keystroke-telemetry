"""Interlink self-test for codebase_vitals.

Auto-generated. This test keeps codebase_vitals interlinked.
...
def test_import():
    ...
    from src.codebase_vitals import snapshot_vitals, append_vitals, load_vitals, record_vitals
...
def test_append_vitals_contract():
    ...
    from src.codebase_vitals import append_vitals
    # smoke test: function exists and is callable
...
def test_load_vitals_contract():
    ...
    from src.codebase_vitals import load_vitals
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for codebase_vitals."""
    ...
    print(f"  codebase_vitals: {status}")
    return passed == total
