"""Interlink self-test for tc_gemini.

Auto-generated. This test keeps tc_gemini interlinked.
...
def test_import():
    ...
    from src.tc_gemini import ThoughtBuffer, call_gemini, log_completion
    ...
    print(f"  ✓ tc_gemini: 3 exports verified")
