"""Interlink self-test for profile_renderer.

Auto-generated. This test keeps profile_renderer interlinked.
...
def test_import():
    ...
    from src.profile_renderer import render_profile, render_profile_index, render_all_profiles
    ...
    print(f"  ✓ profile_renderer: 3 exports verified")

def test_render_profile_contract():
    """Data flow contract: render_profile(ident, root) → output."""
    from src.profile_renderer import render_profile
...
def test_render_profile_index_contract():
    ...
    from src.profile_renderer import render_profile_index
    # smoke test: function exists and is callable
...
def test_render_all_profiles_contract():
    ...
    from src.profile_renderer import render_all_profiles
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for profile_renderer."""
    ...
    print(f"  profile_renderer: {status}")
    return passed == total
