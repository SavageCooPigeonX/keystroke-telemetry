"""Interlink self-test for intent_compressor.

Auto-generated. This test keeps intent_compressor interlinked.
...
def test_import():
    ...
    from src.intent_compressor import strip_metadata, strip_syntactic_noise, collapse_imports, skeleton, intent_map, CompressionResult, compress_file, compress_all
    ...
    print(f"  ✓ intent_compressor: 8 exports verified")

def test_strip_metadata_contract():
    """Data flow contract: strip_metadata(source) → output."""
    from src.intent_compressor import strip_metadata
...
def test_strip_syntactic_noise_contract():
    ...
    from src.intent_compressor import strip_syntactic_noise
    # smoke test: function exists and is callable
...
def test_collapse_imports_contract():
    ...
    from src.intent_compressor import collapse_imports
    # smoke test: function exists and is callable
...
def test_skeleton_contract():
    ...
    from src.intent_compressor import skeleton
    # smoke test: function exists and is callable
...
def test_intent_map_contract():
    ...
    from src.intent_compressor import intent_map
    # smoke test: function exists and is callable
...
def test_compress_file_contract():
    ...
    from src.intent_compressor import compress_file
    # smoke test: function exists and is callable
...
def test_compress_all_contract():
    ...
    from src.intent_compressor import compress_all
    # smoke test: function exists and is callable
    assert compress_all.__name__ == "compress_all"
    print(f"  ✓ compress_all: contract holds")

def run_interlink_test():
    """Run all interlink checks for intent_compressor."""
    ...
    print(f"  intent_compressor: {status}")
    return passed == total
