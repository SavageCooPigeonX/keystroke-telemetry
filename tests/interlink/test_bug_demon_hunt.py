"""Interlink self-test for bug_demon_hunt.

Auto-generated. This test keeps bug_demon_hunt interlinked.
...
def test_import():
    ...
    from src.bug_demon_hunt import BugDemon, run_hunt, run_multi_hunt, analyze_node_memory, gather_proposals, build_distributed_proposal, stress_test_self, main
    ...
    print(f"  ✓ bug_demon_hunt: 8 exports verified")

def test_run_hunt_contract():
    """Data flow contract: run_hunt(demon) → output."""
    from src.bug_demon_hunt import run_hunt
...
def test_run_multi_hunt_contract():
    ...
    from src.bug_demon_hunt import run_multi_hunt
    # smoke test: function exists and is callable
...
def test_analyze_node_memory_contract():
    ...
    from src.bug_demon_hunt import analyze_node_memory
    # smoke test: function exists and is callable
...
def test_gather_proposals_contract():
    ...
    from src.bug_demon_hunt import gather_proposals
    # smoke test: function exists and is callable
...
def test_build_distributed_proposal_contract():
    ...
    from src.bug_demon_hunt import build_distributed_proposal
    # smoke test: function exists and is callable
...
def test_stress_test_self_contract():
    ...
    from src.bug_demon_hunt import stress_test_self
    # smoke test: function exists and is callable
...
def test_main_contract():
    ...
    from src.bug_demon_hunt import main
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for bug_demon_hunt."""
