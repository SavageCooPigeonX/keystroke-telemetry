"""Interlink self-test for persona_intent_synthesizer.

Auto-generated. This test keeps persona_intent_synthesizer interlinked.
...
def test_import():
    ...
    from src.persona_intent_synthesizer import load_all_memories, extract_intents, extract_frustrations, extract_open_tasks, extract_relationships, build_copilot_block, write_intent_snapshot, inject_into_copilot_instructions
    ...
    print(f"  ✓ persona_intent_synthesizer: 8 exports verified")

def test_load_all_memories_contract():
    """Data flow contract: load_all_memories(root) → output."""
    from src.persona_intent_synthesizer import load_all_memories
...
def test_extract_intents_contract():
    ...
    from src.persona_intent_synthesizer import extract_intents
    # smoke test: function exists and is callable
...
def test_extract_frustrations_contract():
    ...
    from src.persona_intent_synthesizer import extract_frustrations
    # smoke test: function exists and is callable
...
def test_extract_open_tasks_contract():
    ...
    from src.persona_intent_synthesizer import extract_open_tasks
    # smoke test: function exists and is callable
...
def test_extract_relationships_contract():
    ...
    from src.persona_intent_synthesizer import extract_relationships
    # smoke test: function exists and is callable
...
def test_build_copilot_block_contract():
    ...
    from src.persona_intent_synthesizer import build_copilot_block
    # smoke test: function exists and is callable
...
def test_write_intent_snapshot_contract():
    ...
    from src.persona_intent_synthesizer import write_intent_snapshot
    # smoke test: function exists and is callable
...
def test_inject_into_copilot_instructions_contract():
    ...
    from src.persona_intent_synthesizer import inject_into_copilot_instructions
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for persona_intent_synthesizer."""
    ...
    print(f"  persona_intent_synthesizer: {status}")
    return passed == total
