"""Interlink self-test for 控w_ops_s008_v008_d0331_册追跑_λI.

Auto-generated. This test keeps 控w_ops_s008_v008_d0331_册追跑_λI interlinked.
...
def test_import():
    ...
    from src.控w_ops_s008_v008_d0331_册追跑_λI import compute_baselines, classify_state, OperatorStats
    ...
    print(f"  ✓ 控w_ops_s008_v008_d0331_册追跑_λI: 3 exports verified")

def test_compute_baselines_contract():
    """Data flow contract: compute_baselines(history, window) → output."""
    from src.控w_ops_s008_v008_d0331_册追跑_λI import compute_baselines
...
def test_classify_state_contract():
    ...
    from src.控w_ops_s008_v008_d0331_册追跑_λI import classify_state
    # smoke test: function exists and is callable
    assert classify_state.__name__ == "classify_state"
    print(f"  ✓ classify_state: contract holds")

def run_interlink_test():
    """Run all interlink checks for 控w_ops_s008_v008_d0331_册追跑_λI."""
    ...
    print(f"  控w_ops_s008_v008_d0331_册追跑_λI: {status}")
    return passed == total
