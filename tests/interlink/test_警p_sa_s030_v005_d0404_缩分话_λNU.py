"""Interlink self-test for 警p_sa_s030_v005_d0404_缩分话_λNU.

Auto-generated. This test keeps 警p_sa_s030_v005_d0404_缩分话_λNU interlinked.
...
def test_import():
    ...
    from src.警p_sa_s030_v005_d0404_缩分话_λNU import check_staleness, inject_staleness_alert
    ...
    print(f"  ✓ 警p_sa_s030_v005_d0404_缩分话_λNU: 2 exports verified")

def test_check_staleness_contract():
    """Data flow contract: check_staleness(root) → output."""
    from src.警p_sa_s030_v005_d0404_缩分话_λNU import check_staleness
...
def test_inject_staleness_alert_contract():
    ...
    from src.警p_sa_s030_v005_d0404_缩分话_λNU import inject_staleness_alert
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for 警p_sa_s030_v005_d0404_缩分话_λNU."""
    ...
    print(f"  警p_sa_s030_v005_d0404_缩分话_λNU: {status}")
    return passed == total
