"""Interlink self-test for bug_profiles.

Auto-generated. This test keeps bug_profiles interlinked.
...
def test_import():
    ...
    print(f"  ✓ bug_profiles: 1 exports verified")
...
def run_interlink_test():
    """Run all interlink checks for bug_profiles."""
