"""Interlink self-test for push_snapshot.

Auto-generated. This test keeps push_snapshot interlinked.
...
def test_import():
    ...
    from src.push_snapshot import capture_snapshot, compute_drift, get_snapshot_history, inject_drift_block
    ...
    print(f"  ✓ push_snapshot: 4 exports verified")
...
def test_compute_drift_contract():
    ...
    from src.push_snapshot import compute_drift
    # smoke test: function exists and is callable
...
def test_get_snapshot_history_contract():
    ...
    from src.push_snapshot import get_snapshot_history
    # smoke test: function exists and is callable
