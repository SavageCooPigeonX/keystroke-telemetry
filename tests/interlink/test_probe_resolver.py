"""Interlink self-test for probe_resolver.

Auto-generated. This test keeps probe_resolver interlinked.
...
def test_import():
    ...
    from src.probe_resolver import resolve_probe, resolve_all_pending
    ...
    print(f"  ✓ probe_resolver: 2 exports verified")
...
def run_interlink_test():
    """Run all interlink checks for probe_resolver."""
