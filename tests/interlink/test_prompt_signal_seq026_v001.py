...
# ── pigeon ────────────────────────────────────
# SEQ: 026 | VER: v001 | 57 lines | ~611 tokens
...
def test_import():
    ...
    from src.p_psg_s026_v001 import log_raw_signal, load_raw_signals, load_latest_raw
...
def test_log_raw_signal_contract():
    ...
    from src.p_psg_s026_v001 import log_raw_signal
...
def test_load_raw_signals_contract():
    ...
    from src.p_psg_s026_v001 import load_raw_signals
    # smoke test: function exists and is callable
...
def test_load_latest_raw_contract():
    ...
    from src.p_psg_s026_v001 import load_latest_raw
    # smoke test: function exists and is callable
