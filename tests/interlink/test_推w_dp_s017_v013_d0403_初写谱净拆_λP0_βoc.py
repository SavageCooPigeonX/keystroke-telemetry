"""Interlink self-test for 推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc.

Auto-generated. This test keeps 推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc interlinked.
...
def test_import():
    ...
    from src.推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc import build_task_context, inject_task_context
    ...
    print(f"  ✓ 推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc: 2 exports verified")

def test_build_task_context_contract():
    """Data flow contract: build_task_context(root) → output."""
    from src.推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc import build_task_context
...
def test_inject_task_context_contract():
    ...
    from src.推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc import inject_task_context
    # smoke test: function exists and is callable
...
def run_interlink_test():
    """Run all interlink checks for 推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc."""
    ...
    print(f"  推w_dp_s017_v013_d0403_初写谱净拆_λP0_βoc: {status}")
    return passed == total
