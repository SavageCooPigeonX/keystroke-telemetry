...
from pigeon_compiler.pigeon_limits_seq003_v001_d0730__central_compliance_thresholds_and_exclude_lc_organism_health_refactor import explain_exclusion
...
def test_exclusion_decision_ignores_generated_test_logs(tmp_path):
    scratch = tmp_path / "test_logs" / "compiler_fallback" / "generated_case.py"
    assert explain_exclusion(scratch, tmp_path)["reason"] == "protected_dir:test_logs"
