# Self-Fix Report — 2026-03-30 5018891

Scanned 254 modules, 241 in import graph.
...
- **Line**: 22
- **Import**: `src.training_pairs_seq027_v002_d0330__training_pair_generator_for_the_lc_gemini_flash_enricher`
- **Fix**: Use glob-based dynamic import instead of hardcoded name

### 2. [CRITICAL] hardcoded_import
- **File**: src/prompt_enricher_seq024_v001.py
- **Line**: 263
- **Import**: `src.context_router_seq027_v002_d0330__shard_relevance_scorer_context_injector_lc_gemini_flash_enricher`
- **Fix**: Use glob-based dynamic import instead of hardcoded name
...
- **File**: pigeon_brain/flow/predictor_seq009_v003_d0330__fires_phantom_electrons_using_cognitive_lc_gemini_flash_enricher.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
...
- **Imports from**: src/shard_manager_seq026_v002_d0330__local_memory_shard_manager_markdown_lc_gemini_flash_enricher.py
- **Imported by**: src/training_writer_seq028_v002_d0330__end_of_prompt_training_pair_lc_gemini_flash_enricher.py

### src/shard_manager_seq026_v002_d0330__local_memory_shard_manager_markdown_lc_gemini_flash_enricher.py
- **Imported by**: src/context_router_seq027_v002_d0330__shard_relevance_scorer_context_injector_lc_gemini_flash_enricher.py, src/training_writer_seq028_v002_d0330__end_of_prompt_training_pair_lc_gemini_flash_enricher.py

### src/training_writer_seq028_v002_d0330__end_of_prompt_training_pair_lc_gemini_flash_enricher.py
- **Imports from**: src/context_router_seq027_v002_d0330__shard_relevance_scorer_context_injector_lc_gemini_flash_enricher.py, src/shard_manager_seq026_v002_d0330__local_memory_shard_manager_markdown_lc_gemini_flash_enricher.py
