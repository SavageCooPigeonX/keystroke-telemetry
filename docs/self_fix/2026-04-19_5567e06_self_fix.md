# Self-Fix Report — 2026-04-19 5567e06

Scanned 2534 modules, 1592 in import graph.
...
- **File**: pigeon_compiler/git_plugin/w_gpmo_s019_v002_d0419_λGI.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
...
- **Fan-in**: 54 dependents
- **Fix**: Module has 54 dependents — changes here break many files
...
### pigeon_compiler/git_plugin/w_gpmo_s019_v002_d0419_λGI.py
- **Imports from**: pigeon_compiler/pigeon_limits.py, pigeon_compiler/session_logger.py
