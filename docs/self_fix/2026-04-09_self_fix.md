# Self-Fix Report — 2026-04-09 

Scanned 633 modules, 629 in import graph.
...
- **File**: src/忆p_qm_s010_v004_d0321_踪稿析_λ18.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
...
### 97. [LOW] dead_export
- **File**: src/codebase_detector.py
- **Line**: 42
- **Function**: `detect_codebase()`
- **Fix**: Consider removing or wiring detect_codebase() into pipeline

### 98. [LOW] dead_export
- **File**: src/codebase_vitals.py
- **Line**: 200
- **Function**: `load_vitals()`
- **Fix**: Consider removing or wiring load_vitals() into pipeline

### 99. [LOW] dead_export
- **File**: src/file_selector.py
- **Line**: 183
- **Function**: `select_files()`
- **Fix**: Consider removing or wiring select_files() into pipeline

### 100. [LOW] dead_export
- **File**: src/file_selector.py
- **Line**: 235
- **Function**: `select_partners()`
- **Fix**: Consider removing or wiring select_partners() into pipeline

### 101. [LOW] dead_export
- **File**: src/push_snapshot.py
- **Line**: 242
- **Function**: `get_snapshot_history()`
- **Fix**: Consider removing or wiring get_snapshot_history() into pipeline

### 102. [LOW] dead_export
- **File**: src/scale_inference.py
- **Line**: 57
- **Function**: `infer_scale()`
- **Fix**: Consider removing or wiring infer_scale() into pipeline

### 103. [LOW] dead_export
- **File**: src/scale_inference.py
- **Line**: 137
- **Function**: `scale_to_token_budget()`
- **Fix**: Consider removing or wiring scale_to_token_budget() into pipeline

### 104. [LOW] dead_export
- **File**: src/scale_inference.py
- **Line**: 142
- **Function**: `scale_to_instructions()`
- **Fix**: Consider removing or wiring scale_to_instructions() into pipeline

### 105. [LOW] dead_export
- **File**: src/tc_popup.py
- **Line**: 16
- **Function**: `run_popup()`
- **Fix**: Consider removing or wiring run_popup() into pipeline

### 106. [LOW] dead_export
- **File**: src/tc_profile.py
- **Line**: 398
- **Function**: `update_profile_from_composition()`
- **Fix**: Consider removing or wiring update_profile_from_composition() into pipeline

### 107. [LOW] dead_export
- **File**: src/tc_profile.py
- **Line**: 438
- **Function**: `bootstrap_profile()`
- **Fix**: Consider removing or wiring bootstrap_profile() into pipeline

### 108. [LOW] dead_export
- **File**: src/tc_web.py
- **Line**: 37
- **Function**: `run_web()`
- **Fix**: Consider removing or wiring run_web() into pipeline

### 109. [LOW] dead_export
- **File**: src/unsaid_accumulator.py
- **Line**: 51
- **Function**: `query()`
- **Fix**: Consider removing or wiring query() into pipeline

### 110. [INFO] high_coupling
- **File**: streaming_layer/_resolve.py
- **Fan-in**: 38 dependents
- **Fix**: Module has 38 dependents — changes here break many files
