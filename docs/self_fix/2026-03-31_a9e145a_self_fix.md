# Self-Fix Report — 2026-03-31 a9e145a

Scanned 260 modules, 247 in import graph.
...
- **File**: src/research_lab_seq029_v004_d0331__the_system_studying_the_system_lc_mutation_patch_pipeline.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
...
- **Imported by**: src/cognitive_reactor_seq014_v005_d0331__cognitive_reactor_autonomous_code_modification_lc_mutation_patch_pipeline.py
...
- **Imports from**: src/cognitive_reactor_seq014/cognitive_reactor_seq014_decision_maker_seq012_v003_d0331__patch_safety_gating_lc_mutation_patch_pipeline.py, src/cognitive_reactor_seq014/cognitive_reactor_seq014_patch_writer_seq011_v003_d0331__apply_code_patches_to_source_lc_mutation_patch_pipeline.py
