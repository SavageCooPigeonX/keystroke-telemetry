# Self-Fix Report — 2026-03-29 fd2ab12

Scanned 211 modules, 198 in import graph.
...
- **File**: src/push_cycle_seq025_v002_d0329__the_push_is_the_unit_lc_selection_aware_os.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
