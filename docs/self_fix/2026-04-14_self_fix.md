# Self-Fix Report — 2026-04-14 

Scanned 2492 modules, 2348 in import graph.
...
- **File**: src/tc_profile/tc_profile_empty_structs_seq003_v001.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)

### 60. [HIGH] over_hard_cap
- **File**: src/tc_profile/tc_profile_intelligence_deductions_seq009_v001.py
- **Fix**: Auto-compile with pigeon compiler (run_clean_split)
...
- **Fan-in**: 110 dependents
- **Fix**: Module has 110 dependents — changes here break many files

### 109. [INFO] high_coupling
- **File**: pigeon_compiler/pigeon_limits.py
- **Fan-in**: 61 dependents
- **Fix**: Module has 61 dependents — changes here break many files

### 110. [INFO] high_coupling
- **File**: src/tc_constants.py
- **Fan-in**: 26 dependents
- **Fix**: Module has 26 dependents — changes here break many files
...
### 131. [INFO] high_coupling
- **File**: pigeon_brain/缩p_fdt_s006_v002_d0323_描环检意_λP.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 132. [INFO] high_coupling
- **File**: pigeon_brain/环检p_ld_s005_v002_d0323_缩描意_λP.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 133. [INFO] high_coupling
- **File**: src/u_cs_s033_v001.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 134. [INFO] high_coupling
- **File**: pigeon_compiler/rename_engine/册f_reg_s012_v005_d0402_追跑谱桥复审_λVR/册f_reg_s012_v005_d0402_追跑谱桥复审_λVR_constants_seq001_v001.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 135. [INFO] high_coupling
- **File**: pigeon_compiler/rename_engine/w_pl_s002_v005_d0401_册追跑谱桥_λA.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 136. [INFO] high_coupling
- **File**: pigeon_compiler/runners/净拆f_rcs_s010_v006_d0322_译测编深划_λW.py
- **Fan-in**: 8 dependents
- **Fix**: Module has 8 dependents — changes here break many files

### 137. [INFO] high_coupling
- **File**: src/prompt_recon_seq016_v001.py
- **Fan-in**: 7 dependents
- **Fix**: Module has 7 dependents — changes here break many files

### 138. [INFO] high_coupling
- **File**: pigeon_compiler/cut_executor/重助p_rehe_s011_v004_d0315_重箱重拆切_λν.py
- **Fan-in**: 7 dependents
- **Fix**: Module has 7 dependents — changes here break many files

### 139. [INFO] high_coupling
- **File**: src/tc_gemini.py
- **Fan-in**: 7 dependents
- **Fix**: Module has 7 dependents — changes here break many files

### 140. [INFO] high_coupling
...
- **File**: pigeon_compiler/cut_executor/重箱f_rebi_s010_v004_d0315_重拆谱建织_λν.py
- **Fan-in**: 5 dependents
- **Fix**: Module has 5 dependents — changes here break many files

### 149. [INFO] high_coupling
- **File**: pigeon_compiler/cut_executor/写w_fw_s003_v005_d0322_译改名踪_λμ.py
- **Fan-in**: 5 dependents
- **Fix**: Module has 5 dependents — changes here break many files

### 150. [INFO] high_coupling
- **File**: pigeon_compiler/cut_executor/析p_pp_s001_v004_d0315_测编深划鸽环_λν.py
- **Fan-in**: 5 dependents
- **Fix**: Module has 5 dependents — changes here break many files
